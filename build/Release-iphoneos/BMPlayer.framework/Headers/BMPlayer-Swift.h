...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BMPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC8BMPlayer8BMPlayer")
...
SWIFT_PROTOCOL("_TtP8BMPlayer27BMPlayerControlViewDelegate_")
...
///
- (void)controlViewWithControlView:(BMPlayerControlView * _Nonnull)controlView didChooseDefinition:(NSInteger)index;
...
@interface BMPlayer (SWIFT_EXTENSION(BMPlayer)) <BMPlayerControlViewDelegate>
- (void)controlViewWithControlView:(BMPlayerControlView * _Nonnull)controlView didChooseDefinition:(NSInteger)index;
- (void)controlViewWithControlView:(BMPlayerControlView * _Nonnull)controlView didPressButton:(UIButton * _Nonnull)button;
- (void)controlViewWithControlView:(BMPlayerControlView * _Nonnull)controlView slider:(UISlider * _Nonnull)slider onSliderEvent:(UIControlEvents)event;
- (void)controlViewWithControlView:(BMPlayerControlView * _Nonnull)controlView didChangeVideoPlaybackRate:(float)rate;
...
SWIFT_CLASS("_TtC8BMPlayer19BMPlayerControlView")
...
- (void)onDoubleTapGestureRecognized:(UITapGestureRecognizer * _Nonnull)gesture;
...
SWIFT_CLASS("_TtC8BMPlayer17BMPlayerLayerView")
...
SWIFT_CLASS("_TtC8BMPlayer12BMTimeSlider")
